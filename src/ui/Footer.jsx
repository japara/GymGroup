...
function Footer() {
  return (
    <div className="flex justify-between items-center px-[5rem] border-t-1 bg-[#4D4D4D] text-[#C4C4C4] fixed bottom-0 left-0 w-full h-[15.25rem]">
      ...
      <div className="flex flex-col font-[400]">
        ...
        <p className="text-[14px] mt-[2rem] mb-[-4rem]">© 2024 Transform with Tuna. All rights reserved.</p>
      </div>
